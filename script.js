...
const SD_SLIDES = [
  ...
  {label:'Super Deluxe — Photo 3',file:'family3.jpeg'},
   {label:'Super Deluxe — Photo 4',file:'wash1.jpg'},
];
const TR_SLIDES = [
  ...
  {label:'Triple Room — Photo 3',file:'triple1.jpeg'},
   ...
   {label:'Triple Room — Photo 5',file:'wash2.png'},
];
const PM_SLIDES = [
  {label:'Family Suite — Photo 1',file:'deluxe1.jpeg'},
  {label:'Family Suite — Photo 2',file:'deluxe2.jpeg'},
  {label:'Family Suite — Photo 3',file:'deluxe4.jpeg'},
  {label:'Family Suite — Photo 4',file:'deluxe5.jpeg'},
   {label:'Family Suite — Photo 5',file:'wash3.png'},
];
...
const MENU_DATA = [
  {category:'☀️ Mini Meals / Breakfast',items:[
    {name:'Bread Butter / Jam (4 Slices)',desc:'Toasted bread with butter or jam',price:'₹110'},
    {name:'Poha',desc:'Flattened rice with mustard, curry leaves, peanuts',price:'₹120'},
    {name:'Masala Maggie',desc:'Classic Maggie noodles with spices',price:'₹120'},
    {name:'Aloo Parantha',desc:'Stuffed whole-wheat flatbread with spiced potato',price:'₹120'},
    {name:'Aloo Pyaz Parantha',desc:'Potato & onion stuffed flatbread',price:'₹130'},
    {name:'Aloo Gobhi Parantha',desc:'Potato & cauliflower stuffed flatbread',price:'₹150'},
    {name:'Mix Parantha',desc:'Mixed vegetable stuffed flatbread',price:'₹150'},
    {name:'Paneer Parantha',desc:'Cottage cheese stuffed flatbread',price:'₹160'},
    {name:'Poori Bhaji',desc:'Puffed bread served with spiced potato curry',price:'₹180'},
    {name:'Pav Bhaji',desc:'Buttered pav with spiced mixed vegetable bhaji',price:'₹195'},
    {name:'Chole Bhature',desc:'Spiced chickpeas with fried bread',price:'₹230'},
    {name:'Amritsari Chole Kulche',desc:'Amritsari style chole with kulcha',price:'₹250'},
    {name:'Extra Bhature (1 Pc)',desc:'Additional bhatura',price:'₹80'},
    {name:'Extra Poori (2 Pcs)',desc:'Additional pooris',price:'₹70'},
    {name:'Extra Pav',desc:'Additional pav bread',price:'₹80'},
  ]},
  {category:'🍲 Soups',items:[
    {name:'Tomato Soup',desc:'Creamy fresh tomato soup',price:'₹150'},
    {name:'Sweet Corn Soup',desc:'Creamy sweet corn soup',price:'₹160'},
    {name:'Hot & Sour Soup',desc:'Tangy Indo-Chinese style hot & sour',price:'₹170'},
    {name:'Veg. Soup',desc:'Mixed vegetable clear soup',price:'₹170'},
    {name:'Manchao Soup',desc:'Hot tangy Indo-Chinese with crispy noodles',price:'₹180'},
  ]},
  {category:'🔥 Tandoor Se (Veg Starters)',items:[
    {name:'Paneer Tikka',desc:'Marinated cottage cheese grilled in tandoor',price:'₹320'},
    {name:'Malai Paneer Tikka',desc:'Creamy marinated paneer tikka',price:'₹340'},
    {name:'Mushroom Tikka',desc:'Spiced mushrooms grilled in tandoor',price:'₹330'},
    {name:'Afghani Paneer Tikka',desc:'Afghani style creamy paneer tikka',price:'₹330'},
    {name:'Nazakat Aloo',desc:'Spiced potato preparation from tandoor',price:'₹270'},
    {name:'Peshawari Aloo',desc:'Peshawari style potato tikka',price:'₹250'},
    {name:'Soya Chaap Tikka',desc:'Tandoor grilled soya chaap with spices',price:'₹340'},
    {name:'Malai Soya Chaap Tikka',desc:'Creamy marinated soya chaap tikka',price:'₹360'},
    {name:'Paneer Tikka Roll',desc:'Paneer tikka wrapped in flatbread',price:'₹350'},
    {name:'Veg. Roll',desc:'Mixed vegetable roll',price:'₹280'},
  ]},
  {category:'🥗 Salad & Papad',items:[
    {name:'Green Salad',desc:'Fresh seasonal green salad',price:'₹90'},
    {name:'Onion Salad',desc:'Sliced onion with lime and spices',price:'₹80'},
    {name:'Masala Pyaz',desc:'Spiced onion mix',price:'₹110'},
    {name:'Garlic Chutney',desc:'Fresh garlic chutney',price:'₹90'},
    {name:'Fry Mirchi',desc:'Fried green chillies',price:'₹70'},
    {name:'Masala Papad',desc:'Crispy papad with masala topping',price:'₹70'},
    {name:'Fry Papad',desc:'Deep fried crispy papad',price:'₹40'},
    {name:'Roasted Papad',desc:'Roasted papad',price:'₹30'},
    {name:'Sabut Dana Papad',desc:'Whole grain papad',price:'₹60'},
  ]},
  {category:'🍟 Starters (Veg)',items:[
    {name:'Bhelpuri',desc:'Puffed rice with chutneys and vegetables',price:'₹170'},
    {name:'Kurkure Bhel',desc:'Crispy kurkure bhel mix',price:'₹180'},
    {name:'Namkeen Shots (6 Pcs)',desc:'Bite-sized namkeen shots',price:'₹180'},
    {name:'Bingo Bhel',desc:'Bingo style bhel mix',price:'₹180'},
    {name:'Nachos Bhel',desc:'Nachos with bhel toppings',price:'₹220'},
    {name:'French Fries',desc:'Crispy golden french fries',price:'₹190'},
    {name:'Peri Peri French Fries',desc:'Spicy peri peri seasoned fries',price:'₹210'},
    {name:'Spring Rolls',desc:'Crispy vegetable stuffed spring rolls',price:'₹230'},
    {name:'Peanut Masala',desc:'Spiced masala peanuts',price:'₹210'},
    {name:'Bhujiya Chaat',desc:'Crispy bhujiya chaat',price:'₹190'},
    {name:'Hara Bhara Kabab',desc:'Spinach and pea cakes, mildly spiced',price:'₹230'},
    {name:'Veg. Pakoda (8 Pcs)',desc:'Crispy mixed vegetable fritters',price:'₹210'},
    {name:'Aloo Chaat',desc:'Spiced potato chaat with chutneys',price:'₹220'},
    {name:'Cheese Balls (6 Pcs)',desc:'Crispy golden cheese balls',price:'₹250'},
    {name:'Paneer Pakoda (8 Pcs)',desc:'Crispy battered paneer fritters',price:'₹250'},
    {name:'Karari Roti',desc:'Crispy Karari roti starter',price:'₹280'},
  ]},
  {category:'🍛 Delicious Veg (Main Course)',items:[
    {name:'Kaju Curry',desc:'Cashew nut in rich creamy gravy',price:'₹370'},
    {name:'Paneer Cheese Rolls',desc:'Paneer cheese rolls in masala',price:'₹320'},
    {name:'Navratan Korma',desc:'Nine-vegetable korma in mild creamy sauce',price:'₹320'},
    {name:'Paneer Tikka Masala',desc:'Grilled paneer in spiced masala gravy',price:'₹320'},
    {name:'Soya Chaap Masala',desc:'Soya chaap in rich masala gravy',price:'₹350'},
    {name:'Paneer Bhurji',desc:'Scrambled spiced cottage cheese',price:'₹310'},
    {name:'Veg. Kolhapuri',desc:'Spicy Kolhapuri style mixed vegetables',price:'₹290'},
    {name:'Dhaba Paneer',desc:'Rustic dhaba style paneer',price:'₹290'},
    {name:'Matar Mushroom',desc:'Peas and mushroom in spiced gravy',price:'₹310'},
    {name:'Kadhai Paneer',desc:'Paneer cooked in kadhai with bell peppers',price:'₹290'},
    {name:'Handi Paneer',desc:'Paneer slow cooked in handi',price:'₹290'},
    {name:'Malai Kofta',desc:'Fried paneer balls in rich cream gravy',price:'₹290'},
    {name:'Paneer Butter Masala',desc:'Paneer in rich tomato-butter-cream sauce',price:'₹280'},
    {name:'Paneer Lababdar',desc:'Paneer in onion-tomato lababdar gravy',price:'₹280'},
    {name:'Shahi Paneer',desc:'Paneer in royal cashew-onion gravy',price:'₹280'},
    {name:'Khoya Paneer',desc:'Paneer with khoya in rich gravy',price:'₹280'},
    {name:'Mushroom Masala',desc:'Button mushrooms in spiced masala',price:'₹285'},
    {name:'Matar Paneer',desc:'Peas and cottage cheese in tomato gravy',price:'₹270'},
    {name:'Palak Paneer',desc:'Cottage cheese in smooth spinach gravy',price:'₹260'},
    {name:'Mix Veg.',desc:'Seasonal vegetables in homestyle masala',price:'₹260'},
    {name:'Veg. Jalfreji',desc:'Stir-fried mixed vegetables Jalfrezi style',price:'₹260'},
    {name:'Chana Masala',desc:'Spiced chickpeas in tangy gravy',price:'₹260'},
    {name:'Sev Tamatar',desc:'Crispy sev with tomato gravy',price:'₹250'},
    {name:'Bhindi Masala',desc:'Spiced okra dry masala',price:'₹250'},
    {name:'Gatta Masala',desc:'Rajasthani gatta in spiced gravy',price:'₹240'},
    {name:'Dum Aloo',desc:'Baby potatoes in rich dum masala',price:'₹240'},
    {name:'Kashmiri Dum Aloo',desc:'Kashmiri style dum aloo in yogurt gravy',price:'₹240'},
    {name:'Haryali Kofta',desc:'Green herb kofta in spinach gravy',price:'₹240'},
    {name:'Dal Palak',desc:'Lentils cooked with spinach',price:'₹240'},
    {name:'Kadhi Pakoda',desc:'Yogurt gravy with fried pakodas',price:'₹230'},
    {name:'Jeera Aloo',desc:'Cumin tempered potatoes',price:'₹220'},
    {name:'Aloo Gobhi',desc:'Potato and cauliflower dry masala',price:'₹220'},
    {name:'Gobhi Masala',desc:'Cauliflower in spiced masala gravy',price:'₹220'},
  ]},
  {category:'🫘 Dal',items:[
    {name:'Dal Fry',desc:'Yellow lentils tempered with spices',price:'₹230'},
    {name:'Dal Tadka',desc:'Dal with classic tadka tempering',price:'₹230'},
    {name:'Dal Dhaba',desc:'Rustic dhaba style mixed dal',price:'₹230'},
    {name:'Dal Makhani',desc:'Slow-cooked black lentils with butter and cream',price:'₹250'},
    {name:'Rajma',desc:'Red kidney beans in spiced gravy',price:'₹250'},
  ]},
  {category:'🍚 Rice',items:[
    {name:'Veg. Biryani',desc:'Fragrant basmati with seasonal vegetables and saffron',price:'₹275'},
    {name:'Veg. Pulaao',desc:'Vegetable pulao with aromatic spices',price:'₹250'},
    {name:'Jeera Rice',desc:'Cumin-tempered long-grain basmati',price:'₹210'},
    {name:'Plain Rice',desc:'Steamed long-grain basmati rice',price:'₹180'},
    {name:'Veg. Biryani With Raita',desc:'Veg biryani served with raita',price:'₹310'},
  ]},
  {category:'🫓 Assorted Breads',items:[
    {name:'Tawa / Tandoori Roti',desc:'Whole-wheat flatbread from tawa or clay oven',price:'₹30'},
    {name:'Butter Tawa / Tandoori Roti',desc:'Buttered whole-wheat flatbread',price:'₹35'},
    {name:'Plain Naan',desc:'Soft leavened bread baked in tandoor',price:'₹90'},
    {name:'Missi Roti',desc:'Spiced gram flour flatbread',price:'₹90'},
    {name:'Lacha Parantha',desc:'Layered flaky whole-wheat bread',price:'₹80'},
    {name:'Missi Onion Roti',desc:'Missi roti with onion',price:'₹110'},
    {name:'Butter Naan',desc:'Soft naan with butter glaze',price:'₹100'},
    {name:'Cheese Naan',desc:'Naan stuffed with melted cheese',price:'₹120'},
    {name:'Stuffed Naan',desc:'Naan stuffed with spiced filling',price:'₹130'},
    {name:'Garlic Naan',desc:'Naan brushed with garlic butter and coriander',price:'₹130'},
    {name:'Ajwain Parantha',desc:'Carom-seed flaky parantha',price:'₹130'},
    {name:'Chur Chur Naan',desc:'Crispy layered chur chur naan',price:'₹150'},
    {name:'Kashmiri Naan',desc:'Sweet naan with dry fruits and coconut',price:'₹170'},
  ]},
  {category:'🥣 Raita',items:[
    {name:'Fruit Raita',desc:'Chilled yogurt with seasonal fruits',price:'₹220'},
    {name:'Veg. Raita',desc:'Yogurt with mixed vegetables',price:'₹180'},
    {name:'Boondi Raita',desc:'Yogurt with fried boondi drops',price:'₹160'},
    {name:'Cucumber Raita',desc:'Chilled yogurt with cucumber',price:'₹140'},
    {name:'Onion Raita',desc:'Yogurt with onion and green chilli',price:'₹140'},
    {name:'Plain Raita',desc:'Simple chilled yogurt',price:'₹130'},
    {name:'Curd',desc:'Fresh set curd',price:'₹90'},
  ]},
  {category:'🍝 Chinese Starter',items:[
    {name:'Honey Chilli Potato',desc:'Crispy potato tossed in honey chilli sauce',price:'₹230'},
    {name:'Veg. Chowmein',desc:'Stir-fried noodles with vegetables',price:'₹210'},
    {name:'Hakka Noodles',desc:'Indo-Chinese style hakka noodles',price:'₹250'},
    {name:'Veg. Fried Rice',desc:'Wok-tossed rice with mixed vegetables',price:'₹250'},
    {name:'Veg. Manchurian (6 Pcs)',desc:'Vegetable balls in tangy Manchurian sauce',price:'₹280'},
    {name:'Chilly Paneer',desc:'Crispy paneer tossed in chilli sauce',price:'₹280'},
    {name:'Nachos Platter',desc:'Loaded nachos platter with dips',price:'₹320'},
    {name:'Chilli Garlic Noodles',desc:'Spicy garlic flavoured noodles',price:'₹250'},
    {name:'Crispy Corn',desc:'Crispy fried corn with spices',price:'₹210'},
  ]},
  {category:'🍕 Italian Starter & Breads',items:[
    {name:'Red Sauce Pasta',desc:'Penne in classic tomato red sauce',price:'₹270'},
    {name:'White Sauce Pasta',desc:'Creamy béchamel white sauce pasta',price:'₹270'},
    {name:'Pink Sauce Pasta',desc:'Pasta in blended pink sauce',price:'₹270'},
    {name:'Bombay Sandwich',desc:'Classic Bombay style grilled sandwich',price:'₹130'},
    {name:'Veg. Sandwich',desc:'Fresh vegetable sandwich',price:'₹150'},
    {name:'Veg. Cheese Grilled Sandwich',desc:'Grilled sandwich with cheese and vegetables',price:'₹170'},
    {name:'Veg. Paneer Tikka Grilled Sandwich',desc:'Grilled sandwich with paneer tikka filling',price:'₹195'},
    {name:'Sweet Corn Cheese Sandwich',desc:'Grilled sandwich with sweet corn and cheese',price:'₹210'},
  ]},
  {category:'🍕 Pizzas',items:[
    {name:'Cheese Pizza',desc:'Classic loaded cheese pizza',price:'₹200'},
    {name:'Magherita',desc:'Traditional tomato and mozzarella pizza',price:'₹240'},
    {name:'OTC Pizza',desc:'Our special OTC pizza',price:'₹260'},
    {name:'Highway Memory Special Pizza',desc:'Chef\'s signature special pizza',price:'₹325'},
    {name:'Paneer Tikka Pizza',desc:'Pizza topped with paneer tikka',price:'₹310'},
  ]},
  {category:'🍽️ Sizzlers',items:[
    {name:'Chinese Sizzler',desc:'Fried Rice, Veg Manchurian, Chilly Paneer, Honey Chilli Potato',price:'₹460'},
    {name:'Italian Sizzler',desc:'Pasta, French Fries, Hakka Noodle, Cheese Balls',price:'₹460'},
    {name:'Tandoori Sizzler',desc:'Paneer Tikka, Aloo Nazakat, Hara Bhara Kabab, Mushroom Tikka',price:'₹520'},
    {name:'Tandoori Platter',desc:'Paneer Tikka, Malai Soya Chaap Tikka, Hara Bhara Kabab, French Fries',price:'₹520'},
  ]},
  {category:'🍱 Thali',items:[
    {name:'Veg. Thali',desc:'Seasonal Veg, Dal, Pickle, Raita, 3 Tawa Roti / Tandoori Roti, Rice, Salad',price:'₹350'},
    {name:'Special Thali',desc:'Seasonal Veg, Dal Fry, Paneer Preparation, Pickle, Raita, Salad, Rice, 2 Tandoori Roti, 1 Laccha Parantha, 1 Papad, Chutney, 1 Sweet',price:'₹400'},
  ]},
  {category:'🍮 Desserts',items:[
    {name:'Gulab Jamun (2 Pcs)',desc:'Soft milk-solid dumplings in rose sugar syrup',price:'₹120'},
    {name:'Rasgulla (2 Pcs)',desc:'Light cottage cheese balls in sugar syrup',price:'₹110'},
    {name:'Rasmalai (2 Pcs)',desc:'Soft paneer discs in saffron-flavoured milk',price:'₹190'},
    {name:'Gulab Jamun With Ice Cream',desc:'Gulab jamun served with vanilla ice cream',price:'₹180'},
  ]},
  {category:'🍦 Frozen Dessert',items:[
    {name:'Vanilla Ice Cream',desc:'Classic creamy vanilla ice cream',price:'₹150'},
    {name:'Butter Scotch Ice Cream',desc:'Butterscotch flavoured ice cream',price:'₹150'},
    {name:'Chocolate Ice Cream',desc:'Rich chocolate ice cream',price:'₹150'},
    {name:'Strawberry Ice Cream',desc:'Fresh strawberry flavoured ice cream',price:'₹150'},
    {name:'American Nuts',desc:'Ice cream with american nuts topping',price:'₹150'},
    {name:'Chocho Chip Ice Cream',desc:'Choco chip ice cream',price:'₹150'},
    {name:'Havmor Ice Cream',desc:'Havmor brand ice cream — available flavours on request',price:'Available'},
  ]},
  {category:'🥤 Beverages Cold',items:[
    {name:'Butter Milk / Chaach',desc:'Chilled spiced yogurt drink',price:'₹80'},
    {name:'Mineral Water',desc:'Packaged mineral water',price:'₹25'},
    {name:'Sweet Lassi',desc:'Chilled sweet yogurt lassi',price:'₹95'},
    {name:'Cold Drink (500 ML)',desc:'Assorted cold beverages',price:'₹60'},
    {name:'Ice Tea',desc:'Chilled iced tea',price:'₹150'},
    {name:'Cold Coffee',desc:'Blended iced coffee',price:'₹185'},
    {name:'Cold Coffee With Ice Cream',desc:'Cold coffee topped with ice cream',price:'₹225'},
    {name:'Lemonade',desc:'Fresh lime lemonade',price:'₹190'},
  ]},
  {category:'🥤 Shakes',items:[
    {name:'Vanilla Shake',desc:'Classic creamy vanilla milkshake',price:'₹225'},
    {name:'Pineapple Shake',desc:'Fresh pineapple milkshake',price:'₹220'},
    {name:'Strawberry Shake',desc:'Fresh strawberry milkshake',price:'₹220'},
    {name:'Butterscotch Shake',desc:'Butterscotch flavoured milkshake',price:'₹230'},
    {name:'Virgin Mojito',desc:'Refreshing mint lime mojito',price:'₹185'},
    {name:'Chocolate Shake',desc:'Rich chocolate milkshake',price:'₹230'},
    {name:'Americano Shake',desc:'Coffee style americano shake',price:'₹195'},
    {name:'Oreo Shake',desc:'Oreo cookie blended milkshake',price:'₹250'},
    {name:'Five Star Shake',desc:'Five Star chocolate bar milkshake',price:'₹250'},
    {name:'Kitkat Shake',desc:'Kitkat chocolate milkshake',price:'₹250'},
  ]},
  {category:'☕ Beverages Hot',items:[
    {name:'Black Tea',desc:'Classic black tea',price:'₹50'},
    {name:'Green Tea',desc:'Refreshing green tea',price:'₹60'},
    {name:'Masala Tea',desc:'Spiced ginger masala chai',price:'₹50'},
    {name:'Tulsi Tea',desc:'Tulsi (holy basil) herbal tea',price:'₹50'},
    {name:'Hot Milk',desc:'Fresh hot milk',price:'₹80'},
    {name:'Caffe Classic',desc:'Classic hot coffee',price:'₹80'},
  ]},
];
